    ...
    class ChatWidget {
        constructor(config) {
            this.config = {
                ...
                style: {
                    ...config.style,
                    titleColor: config.style.titleColor || '#ffffff'
                }
            };
            this.isOpen = false;
            this.messages = [];
        ...
        createStyles() {
            ...
            style.textContent = `
                ...
                .chat-title {
                    color: ${this.config.style.titleColor} !important;
                    font-weight: bold;
                    font-size: 16px;
                    margin: 0;
                    padding: 0;
                ...
                .chat-welcome {
                    color: ${this.config.style.titleColor};
                    font-size: 12px;
                    opacity: 0.9;
                    margin-top: 4px;
                }
                ...
                <div class="chat-widget">
                    ...
                    ''}
                        <div class="chat-header-content">
                            <div class="chat-title">${this.config.branding.name}</div>
                            <div class="chat-welcome">${this.config.branding.welcomeText}</div>
                        </div>
                    </div>
